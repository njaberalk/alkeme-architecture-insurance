  ...
  return (
    <div ref={ref} className="bg-stone fade-in-view" style={{ padding: '4rem 0' }}>
      <div className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
        <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-6" style={{ fontSize: '1.5rem' }}>Architecture Insurance in Nearby States</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-2">
              {['professional-liability', 'general-liability', 'workers-compensation', 'cyber-liability', 'umbrella-excess'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {['residential-architecture', 'commercial-architecture', 'healthcare-design', 'structural-engineering', 'sustainable-design'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                { slug: 'architecture-insurance-cost', label: 'How Much Does Architecture Insurance Cost?' },
                { slug: 'professional-liability-guide', label: 'Professional Liability Guide' },
                { slug: 'contract-risk-transfer', label: 'Contract Risk Transfer Guide' },
                { slug: 'architecture-insurance-glossary', label: 'Insurance Glossary' },
              ].map(r => (
        ...
        <section className="bg-stone" style={{ padding: '5rem 0' }}>
          <div className="max-w-[900px] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
            <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-8 text-center" style={{ fontSize: 'clamp(1.8rem, 3vw, 2.2rem)' }}>
              Architecture Insurance FAQ — {state.name}
            </h2>
