...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alkemeins.com/architecture/industries/${industry.slug}/`,
    },
    openGraph: {
      title: industry.metaTitle,
      description: industry.metaDescription,
      url: `https://alkemeins.com/architecture/industries/${industry.slug}/`,
      type: 'website',
    },
  };
}
...
export default async function IndustryPage({ params }) {
  ...
  const jsonLd = {
    ...
    provider: { '@type': 'InsuranceAgency', name: 'ALKEME Insurance Services', url: 'https://alkemeins.com/architecture' },
    description: industry.metaDescription,
    url: `https://alkemeins.com/architecture/industries/${industry.slug}/`,
    serviceType: 'Architecture Firm Insurance',
