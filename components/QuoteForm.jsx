        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-cream font-light mb-8" style={{ lineHeight: '22px', maxWidth: '500px' }}>
              Tell us about your practice and our design professional insurance specialists will reach out with tailored coverage options. No obligation — just expert guidance from a team that understands architecture.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[2rem]" style={{ minHeight: '400px' }}>
            <img
              ...
              alt="Architecture firm insurance specialist helping design professionals find coverage"
              width={800}
              height={600}
            ...
            <div className="relative h-full flex flex-col items-center justify-center text-center p-10" style={{ minHeight: '400px' }}>
              ...
              <p className="text-cream/80 font-light mb-8 max-w-sm" style={{ fontSize: '0.95rem', lineHeight: '1.5' }}>
                Our specialists understand design practices inside and out. Get coverage tailored to the way you work.
              </p>
              <button
                onClick={() => window.dispatchEvent(new Event('open-quote-modal'))}
